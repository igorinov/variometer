...
The app is available on [F-Droid](https://f-droid.org/en/packages/info.altimeter.variometer/) and [Google Play](https://play.google.com/store/apps/details?id=info.altimeter.variometer&hl=en_US).
